...
class AddKFunctionBuilder(private val fragmentClass: FragmentClass) {

    fun build(fileBuilder: FileSpec.Builder) {
        val name = "add" + fragmentClass.simpleName
        ...
        if (sharedElements.isEmpty()) {
            funBuilderOfContext.addStatement("return %T.showFragment(this, false, containerId, tag, intent.getExtras(), %T::class.java, null)", FRAGMENT_BUILDER.kotlin, fragmentClass.typeElement)
        } else {
            ...
            funBuilderOfContext.addStatement("return %T.showFragment(this, false, containerId, tag, intent.getExtras(), %T::class.java, sharedElements)", FRAGMENT_BUILDER.kotlin, fragmentClass.typeElement)
        }
