...
public class KotlinTypes {
    ...
    public static final ClassName ON_ACTIVITY_RESULT_LISTENER = new ClassName("com.bennyhuo.activitybuilder.runtime.core", "OnActivityResultListener");
    public static final ClassName ACTIVITY_BUILDER = new ClassName("com.bennyhuo.activitybuilder.runtime.core", "ActivityBuilder");
    public static final ClassName FRAGMENT_BUILDER = new ClassName("com.bennyhuo.activitybuilder.runtime.core", "FragmentBuilder");
    public static final ClassName ON_ACTIVITY_CREATE_LISTENER = new ClassName("com.bennyhuo.activitybuilder.runtime.core", "OnActivityCreateListener");
    public static final ClassName ON_FRAGMENT_CREATE_LISTENER = new ClassName("com.bennyhuo.activitybuilder.runtime.core", "OnFragmentCreateListener");
